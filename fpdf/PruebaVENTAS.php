...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('..\imagenes\logo.png', 10, 5, 80); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      $this->Image('..\imagenes\LogoGesimasHD.png', 150, 5, 55); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      $this->Ln(7);
      $this->Ln(7);
      ...
      /* CAMPOS DE LA TABLA */
      //color
      $this->SetFillColor(218, 17, 36); //colorFondo
   ...
   function Footer()
   {
      ...
      $this->Cell(190, 10, utf8_decode('--------------------                       ----------------------'), 0, 1, 'C', 0);
