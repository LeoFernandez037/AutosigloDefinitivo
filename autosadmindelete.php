    ...
    <div class="wrapper">
        ...
        <div class="main" id= "main">
            <nav class="navbar navbar-expand px-3 border-bottom">
                <h2>Eliminar Autos</h2>
                <!-- <a class="modal_close" href="">&times;</a> -->
                <a href="autosadmindelete.php?id=<?php echo $id?>" class="btn btn-success btn-sm" style = "margin-left:10px;">Refrescar Tabla</a>
                        ...
                        <?php  
                            ...
                            while($row = mysqli_fetch_array($result_tasks)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="autosdelete.php?id=<?php echo $id?>&id_auto=<?php echo $row['ID_AUTO']?>&id_caracteristica=<?php echo $row['ID_CARACTERISTICA']?> " class="btn btn-primary btn-sm">Eliminar</a>
                                    </td>
                                </tr>
                        <?php } ?>
                    </tbody>
