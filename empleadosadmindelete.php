    ...
    <div class="wrapper">
        ...
        <div class="main" id= "main">
            <nav class="navbar navbar-expand px-3 border-bottom">
                ...
                <a href="empleadosadmindelete.php?id=<?php echo $id?>" class="btn btn-success btn-sm" style = "margin-left:10px;">Refrescar Tabla</a>
                        ...
                        <?php  
                            ...
                            while($row = mysqli_fetch_array($result_tasks)) { ?>
                                ...
                                <td> <img src="<?php echo $row['FOTO']; ?>" alt="nai" style="margin-left: 50px; width: 40px;  border-radius: 100%;" srcset=""></td>
                                    ...
                                    <td>
                                        <a href="empleadosdelete.php?id=<?php echo $id?>&id_persona=<?php echo $row['ID_PERSONA']?>" class="btn btn-primary btn-sm">Eliminar</a>
                                    </td>
                                </tr>
                        <?php } ?>
                    </tbody>
