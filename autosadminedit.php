    ...
    <div class="wrapper">
        ...
        <div class="main" id= "main">
            <nav class="navbar navbar-expand px-3 border-bottom">
                ...
                <a href="autosadminedit.php?id=<?php echo $id?>" class="btn btn-success btn-sm" style = "margin-left:10px;">Refrescar Tabla</a>
                        ...
                        <?php  
                            ...
                            while($row = mysqli_fetch_array($result_tasks)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="autosedit.php?id=<?php echo $id?>&id_auto=<?php echo $row['ID_AUTO']?> " class="btn btn-primary btn-sm">Editar</a>
                                    </td>
                                </tr>
                        <?php } ?>
                    </tbody>
