    ...
    <div class="wrapper">
        ...
        <div class="main">
            <nav class="navbar navbar-expand px-3 border-bottom">
                <h2>Repuestos</h2>
                <a href="repuestos.php?id=<?php echo $id?>" class="btn btn-success btn-sm" style = "margin-left:10px;">Refrescar Tabla</a>
                            ...
                            <?php  
                                ...
                                while($row = mysqli_fetch_array($result_tasks)){?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="repuestosempleadovista.php?id=<?php echo $id?>&id_repuesto=<?php echo $row['ID_REPUESTO']?> " class="btn btn-primary btn-sm">Ver más detalles</a>
                                        </td>
